...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="https://www.hostinger.co.id/"><img src="https://raw.githubusercontent.com/hostinger/banners/master/hostinger_welcome/images/hostinger-logo.png" width="120"></a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a href="https://www.hostinger.co.id/tutorial/"><i aria-hidden="true" class="fa fa-graduation-cap"></i> Tutorial</a>
                </li>
                <li>
                    <a href="https://www.hostinger.co.id/make-money-online"><i aria-hidden="true" class="fa fa-trophy"></i> Sukses bersama kami</a>
                </li>
                <li>
                    <a href="https://www.hostinger.co.id/afiliasi"><i aria-hidden="true" class="fa fa-user"></i> Afiliasi</a>
                </li>
                <li>
                    <a href="https://cpanel.hostinger.co.id"><i aria-hidden="true" class="fa fa-lock"></i> Masuk</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="column-wrap clearfix">
            ...
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.co.id/penghasilan-online">Pelajari lebih lanjut</a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.co.id/pengetahuan-dasar">Pelajari lebih lanjut</a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.com/blog/">Pelajari lebih lanjut</a>
                </div>
            </div>
        </div>
        ...
        <div class="footer">
            <div class="row">
                <div class="text-center" style="margin-bottom: 10px;">
                    <a href="https://www.hostinger.co.id/web-hosting">Web Hosting</a> |
                    <a href="https://cpanel.hostinger.co.id">Klien masuk</a>
                </div>
                <div class="copyright text-center">
                    Hostinger © 2017. Hak cipta dilindungi.
                </div>
            </div>
        </div>
    </div>
